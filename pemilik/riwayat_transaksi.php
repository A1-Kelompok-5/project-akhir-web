...
if(isset($_POST["cari"])) {
    ...
    $query = "SELECT * FROM riwayat_transaksi WHERE status LIKE '%".$pencarian."%' ORDER BY id asc";
}else {
    $query = "SELECT * FROM riwayat_transaksi ORDER BY id asc";
}
...
<head>
    ...
    <title>Pemilik | Data Riwayat Transaksi</title>
...
<body>
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="transaksi.php">Data Transaksi</a></li>
                <li><a class="dropdown-item" href="riwayat_transaksi.php">Data Riwayat Transaksi</a></li>
            </ul>
            </li>
    ...
    <div class="container text-center">
        ...
        <div class="row py-2">
            <div class="col-lg-10 mx-auto"><br><br><br>
                <h1 class="fw-semibold">Data Riwayat Transaksi</h1><br><p class="text-center">
                </p>
            </div>
        </div>
    </div>
    ...
    <div>
        <form action="" method="post" style="text-align: center;">
            <input type="text" name="cari" placeholder="status pembayaran" autocomplete="off" autofocus size="50" value="<?php if(isset($_POST['cari'])){ echo $_POST['cari']; } ?>">
